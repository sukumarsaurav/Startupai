...
<head>
    ...
    <title>Admin Login | StartupAI</title>
    <!-- Font Awesome Icons -->
...
<body class="bg-gray-200">
                            ...
                            <ul class="navbar-nav mx-auto">
                                <li class="nav-item">
                                    <a class="nav-link d-flex align-items-center me-2" href="../index.php">
                                        <i class="material-icons opacity-6 me-1">home</i>
                                        Home
                                    </a>
                                </li>
                            </ul>
    ...
    <main class="main-content mt-0">
        <div class="page-header align-items-start min-vh-100" style="background-image: url('../assets/images/admin-bg.jpg');">
                    ...
                    <div class="row align-items-center justify-content-center">
                        <div class="col-12 col-md-6 my-auto">
                            <div class="copyright text-center text-sm text-white">
                                © <?php echo date('Y'); ?> StartupAI. All Rights Reserved.
                            </div>
                        </div>
                    </div>
                </div>
